...
def parse_opt():
    ...
    parser.add_argument('--prop_thresh', type=float, default=0.2,
                    help='shold to filter out low-confidence proposals')

    parser.add_argument('--overlap_type', type=str, default='IOU',
                    help='IOU, Both')
    parser.add_argument('--iou_thresh', type=float, default=0.5,
                    help='a threshold used for IOU overlap')
    parser.add_argument('--iop_thresh', type=float, default=0.9,
                    help='a threshold used for IOP overlap')
    ...
    parser.add_argument('--loss_type', type=str, default='positive', help='positive means using positive gt boxes, negtive means using negtive gt boxes')
    parser.add_argument('--topk_neg',type=int, default=10)
    parser.add_argument('--topk_pos',type=int, default=10)
    parser.add_argument('--topkr_neg',type=float, default=0.3)
    parser.add_argument('--topkr_pos',type=float, default=0.3)
    parser.add_argument('--topk',type=int, default=10)
    parser.add_argument('--bgfuse',type=int, default=0)
    ...
    parser.add_argument('--val_split', type=str, default='validation',
                    help='')
    parser.add_argument('--test_split', type=str, default='testing',
                    help='')
    ...
    parser.add_argument('--acc_num', type=int, default=1, help='')
